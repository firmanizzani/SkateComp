...
async function main() {
  ...
  await prisma.admin.createMany({
    data: [
      { id_admin: 'AD001', nama_admin: 'Rangga Wibowo', email: 'rangga@admin.com', password: await bcrypt.hash('adminpassword123', 10) },
      { id_admin: 'AD002', nama_admin: 'Sinta Marlina',  email: 'sinta@admin.com',  password: await bcrypt.hash('adminpassword123', 10) },
      { id_admin: 'AD003', nama_admin: 'Yusuf Hakim',    email: 'yusuf@admin.com',  password: await bcrypt.hash('adminpassword123', 10) },
    ],
    skipDuplicates: true,
  });
  ...
  await prisma.juri.createMany({
    data: [
      { id_juri: 'JR001', nama_juri: 'Andi Pratama',  no_hp: '081111111111', email: 'andi@juri.com',  password: await bcrypt.hash('juripassword123',  10) },
      { id_juri: 'JR002', nama_juri: 'Budi Santoso',  no_hp: '082222222222', email: 'budi@juri.com',  password: await bcrypt.hash('juripassword123', 10) },
      { id_juri: 'JR003', nama_juri: 'Citra Lestari', no_hp: '083333333333', email: 'citra@juri.com', password: await bcrypt.hash('juripassword123',  10) },
    ],
    skipDuplicates: true,
  });
  ...
  console.log('   ADMIN    → rangga@admin.com    | adminpassword123');
  console.log('   ADMIN    → sinta@admin.com     | adminpassword123');
  console.log('   JURI     → andi@juri.com       | juripassword123');
  console.log('   JURI     → budi@juri.com       | juripassword123');
